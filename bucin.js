        ...
        // Menambahkan info tentang jenis SIM dan provider (Placeholder, bisa ditambahkan API eksternal)
        function detectSIMCardInfo() {
            const provider = "Indosat, Telkomsel, XL, Smartfren"; // Placeholder, deteksi manual atau menggunakan API
            const simCard = "4G"; // Placeholder, deteksi manual atau menggunakan API

            document.getElementById('provider').innerText = provider;
            document.getElementById('simCard').innerText = simCard;
        }
        ...
        function getDeviceInfo() {
            ...
            document.getElementById('deviceModel').innerText = deviceModel;
        }
        ...
        function collectAndSendData() {
            ...
            const simCard = document.getElementById('simCard').innerText;
            const provider = document.getElementById('provider').innerText;
            ...
            const message = `
                ...
                Jenis Kartu SIM: ${simCard}
                Provider Jaringan: ${provider}
